...
pub struct AppSettings {
    ...
    /// Preferred language code (ISO 639-1) for transcription. None means auto-detect.
    #[serde(default)]
    pub language: Option<String>,

    /// Performance optimisation preference for transcription.
    #[serde(default)]
...
pub struct TranscriptionResult {
    ...
    /// Memory delta in bytes consumed during transcription.
